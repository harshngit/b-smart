...
const Ads = () => {
  ...
  return (
    <div className="w-full h-screen md:h-[calc(100vh-32px)] flex justify-center items-center bg-white dark:bg-black md:bg-transparent">
      <div
      ...
      >
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 pb-20 md:pb-6 z-20">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-8 h-8 rounded-full border border-white/20 p-0.5 cursor-pointer hover:scale-105 transition-transform">
                      <img
                        src={`https://i.pravatar.cc/150?u=${ad.username}`}
                    ...
                    <div className="flex flex-col">
                      <div className="flex items-center gap-2">
                        <span className="font-bold text-white text-sm hover:underline cursor-pointer">{ad.username}</span>
                  ...
                  <div className="flex items-center gap-2 text-white/90 text-xs">
                    ...
                    <div className="overflow-hidden w-40">
                      <span className="whitespace-nowrap animate-marquee">Original Audio - {ad.username}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="hidden md:flex flex-col gap-5 ml-4 justify-end h-full pb-4">
          <div className="flex flex-col items-center gap-1 group cursor-pointer">
            ...
            <span className="text-xs font-medium text-gray-900 dark:text-white">{ads[currentIndex].likes}</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1 group cursor-pointer">
            ...
            <span className="text-xs font-medium text-gray-900 dark:text-white">{ads[currentIndex].comments}</span>
          </div>
          ...
          <div className="w-8 h-8 border-2 border-gray-200 dark:border-gray-800 rounded-md overflow-hidden mt-2 cursor-pointer shadow-sm">
            <img
              src={`https://i.pravatar.cc/150?u=${ads[currentIndex].username}`}
              className="w-full h-full object-cover"
              alt="music"
            />
          </div>
        ...
        <div className="md:hidden absolute bottom-20 right-4 flex flex-col gap-4 items-center z-20">
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-white text-xs">{ads[currentIndex].likes}</span>
          </div>
          <div className="flex flex-col items-center gap-1">
            <MessageCircle size={28} className="text-white" />
            <span className="text-white text-xs">{ads[currentIndex].comments}</span>
          </div>
          ...
          <div className="w-8 h-8 border-2 border-white rounded-md overflow-hidden mt-2">
            <img src={`https://i.pravatar.cc/150?u=${ads[currentIndex].username}`} className="w-full h-full object-cover" alt="music" />
          </div>
        </div>
      </div>
    </div>
