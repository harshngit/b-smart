...
const VerifyOtp = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col px-6 py-8">
      <Link to="/signup" className="inline-flex items-center text-gray-500 mb-8 hover:text-gray-900 transition-colors">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-pink-50 rounded-full flex items-center justify-center mx-auto mb-4 text-[#fa3f5e]">
            <ShieldCheck size={32} />
          </div>
        ...
        <form onSubmit={handleVerify} className="space-y-6">
          {!location.state?.email && (
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 focus:border-[#fa3f5e] focus:ring-1 focus:ring-[#fa3f5e] outline-none transition-all"
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-100 focus:border-[#fa3f5e] focus:ring-1 focus:ring-[#fa3f5e] outline-none transition-all text-center tracking-widest text-lg font-mono"
              placeholder="000000"
              maxLength={6}
            />
          </div>
