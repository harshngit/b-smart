...
import {
  ...
  Stepper, SectionCard, Checkbox, Dropdown, HighlightsList, DimensionsInput, WeightInput,
...
const AddProduct = () => {
  ...
  const [form, setForm] = useState({
    ...
    packageWeight: '', weightUnit: 'kg', dimLength: '', dimWidth: '', dimHeight: '', dispatchTime: '', hsnGst: '',
    countryOfOrigin: 'India', useStoreDelivery: true,
    returnPolicy: RETURN_POLICY_OPTIONS[0], useStoreReturnPolicy: true,
        ...
        <div className="space-y-4 lg:sticky lg:top-6">
          <div className="border border-gray-200 dark:border-gray-800 rounded-xl p-4">
            ...
            <div className="flex items-center gap-1 mt-1 mb-1.5">
              ...
              <span className="text-xs text-gray-500 dark:text-gray-400">New listing</span>
            </div>
