          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 sticky top-24">
              ...
              <div className="space-y-2">
                {['All', 'Clothing', 'Accessories', 'Electronics', 'Home & Living'].map((cat) => (
                  <label key={cat} className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className="text-sm text-gray-600 group-hover:text-[#fa3f5e] transition-colors">{cat}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600">
                <input type="number" placeholder="Min" className="w-20 px-2 py-1 border rounded bg-gray-50 focus:outline-none focus:border-[#fa3f5e]" />
                <span>-</span>
                <input type="number" placeholder="Max" className="w-20 px-2 py-1 border rounded bg-gray-50 focus:outline-none focus:border-[#fa3f5e]" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <select className="w-full appearance-none bg-gray-50 border border-gray-200 text-gray-700 py-2 px-3 rounded leading-tight focus:outline-none focus:bg-white focus:border-[#fa3f5e] text-sm">
        ...
        <div className="flex-1">
          <div className="px-4 md:px-0 py-2">
            <div className="bg-gradient-to-r from-insta-purple via-insta-pink to-insta-orange p-[2px] rounded-lg">
              <div className="bg-white rounded-[6px] flex items-center px-3 py-2">
                <Search size={20} className="text-gray-500 mr-2" />
                <input type="text" placeholder="Search shops" className="bg-transparent focus:outline-none w-full" />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4 mt-2 px-2 md:px-0">
            {images.map((img, i) => (
              <div key={i} className="group relative aspect-square bg-gray-200 rounded-lg overflow-hidden cursor-pointer">
                <img src={img} alt="Product" className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110" />
                <div className="absolute bottom-2 left-2 bg-white/90 backdrop-blur-sm px-2 py-1 rounded text-xs font-bold shadow-sm">
                  ${(i + 1) * 15}
                </div>
